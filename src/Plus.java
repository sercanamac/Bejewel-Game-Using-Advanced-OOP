...
public class Plus extends MathSymbol {
    private ArrayList<String> searches = new ArrayList<String>(Arrays.asList("horizontalLeft", "horizontalRight", "verticalUp", "verticalDown"));
